...
public class SalaryController extends BaseController {
	...
	public String frontlist(@ModelAttribute("employeeObj") Employee employeeObj,String giveDate,Integer currentPage, Model model, HttpServletRequest request) throws Exception  {
		if (currentPage==null || currentPage == 0) currentPage = 1;
		if (giveDate == null) giveDate = "";
		List<Salary> salaryList = salaryService.querySalary(employeeObj, giveDate, currentPage);
	    /*计算总的页数和总的记录数*/
	    salaryService.queryTotalPageAndRecordNumber(employeeObj, giveDate);
	    /*获取到总的页码数目*/
	    int totalPage = salaryService.getTotalPage();
