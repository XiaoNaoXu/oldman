...
public class DepartmentController extends BaseController {
	...
	public void listAll(HttpServletResponse response) throws Exception {
		...
		for(Department department:departmentList) {
			...
			jsonDepartment.accumulate("departName", department.getDepartName());
			jsonArray.put(jsonDepartment);
		}
	...
	public void OutToExcel( Model model, HttpServletRequest request,HttpServletResponse response) throws Exception {
        ...
        String[] headers = { "部门编号","部门名称","成立日期","负责人"};
        List<String[]> dataset = new ArrayList<String[]>(); 
        for(int i=0;i<departmentList.size();i++) {
        	Department department = departmentList.get(i); 
        	dataset.add(new String[]{department.getDepartmentId() + "",department.getDepartName(),department.getBornDate(),department.getMainPerson()});
        }
        /*
