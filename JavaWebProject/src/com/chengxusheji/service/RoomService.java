...
public class RoomService {
    ...
    /*按照查询条件分页查询房间记录*/
    public ArrayList<Room> queryRoom(String roomNo,RoomType roomTypeObj,String roomName,String roomState,int currentPage) throws Exception { 
     	String where = "where 1=1";
    	if(!roomNo.equals("")) where = where + " and t_room.roomNo like '%" + roomNo + "%'";
    	if(null != roomTypeObj && roomTypeObj.getTypeId()!= null && roomTypeObj.getTypeId()!= 0)  where += " and t_room.roomTypeObj=" + roomTypeObj.getTypeId();
    	if(!roomName.equals("")) where = where + " and t_room.roomName like '%" + roomName + "%'";
    ...
    /*按照查询条件查询所有记录*/
    public ArrayList<Room> queryRoom(String roomNo,RoomType roomTypeObj,String roomName,String roomState) throws Exception  { 
     	String where = "where 1=1";
    	if(!roomNo.equals("")) where = where + " and t_room.roomNo like '%" + roomNo + "%'";
    	if(null != roomTypeObj && roomTypeObj.getTypeId()!= null && roomTypeObj.getTypeId()!= 0)  where += " and t_room.roomTypeObj=" + roomTypeObj.getTypeId();
    	if(!roomName.equals("")) where = where + " and t_room.roomName like '%" + roomName + "%'";
    ...
    /*当前查询条件下计算总的页数和记录数*/
    public void queryTotalPageAndRecordNumber(String roomNo,RoomType roomTypeObj,String roomName,String roomState) throws Exception {
     	String where = "where 1=1";
    	if(!roomNo.equals("")) where = where + " and t_room.roomNo like '%" + roomNo + "%'";
    	if(null != roomTypeObj && roomTypeObj.getTypeId()!= null && roomTypeObj.getTypeId()!= 0)  where += " and t_room.roomTypeObj=" + roomTypeObj.getTypeId();
    	if(!roomName.equals("")) where = where + " and t_room.roomName like '%" + roomName + "%'";
