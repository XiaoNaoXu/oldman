...
<%
    ...
    String giveDate = (String)request.getAttribute("giveDate"); //发放日期查询关键字
%>
<!DOCTYPE html>
<html>
<head>
...
<jsp:include page="../header.jsp"></jsp:include>
				    		...
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>序号</td><td>工资id</td><td>员工</td><td>工资年份</td><td>工资月份</td><td>工资金额</td><td>发放日期</td><td>操作</td></tr>
				    					<% 
				    						/*计算起始序号*/
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="salaryQueryForm" id="salaryQueryForm" action="<%=basePath %>Salary/frontlist" class="mar_t15" method="post">
			...
			<div class="form-group">
				<label for="giveDate">发放日期:</label>
				<input type="text" id="giveDate" name="giveDate" class="form-control"  placeholder="请选择发放日期" value="<%=giveDate %>" onclick="SelectDate(this,'yyyy-MM-dd')" />
			</div>
