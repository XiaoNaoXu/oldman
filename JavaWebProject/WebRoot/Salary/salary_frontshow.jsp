...
<div class="container">
	...
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">发放日期:</div>
		<div class="col-md-10 col-xs-6"><%=salary.getGiveDate()%></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">工资备注:</div>
		<div class="col-md-10 col-xs-6"><%=salary.getSalaryMemo()%></div>
	</div>
	<div class="row bottom15">
